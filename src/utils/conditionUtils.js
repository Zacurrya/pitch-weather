...
/*
Average temperature across the pastHourly entries (degrees C).
*/
...
@param recentRainMm Total precipitation over the past 48h (mm)
...
/**
Convert a percentage to a more understandable label.
@param pct  0-100
@param type 'wetness' or 'muddiness'
*/
